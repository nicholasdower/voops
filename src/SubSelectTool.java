...
public class SubSelectTool extends Tool implements Selectable
{
  ...
  public SubSelectTool( DrawingArea aDrawingArea, int aType )
  {
    ...
    setCursor(OOPSCursors.SUB_SELECT);
  }

  public SubSelectTool( DrawingArea aDrawingArea )
  {
